...
Missing data were then imputed with various methodologies, including mean imputation, mode imputation, median imputation, MICE, and random forest. This resulted in 5 unique datasets, where missing data were imputed using different metholodologies. To compare the effectiveness of each imputation method, each of the imputed datasets were split into test and training datasets. The training set was used to develop machine learning models to predict Ozone levels, including decision trees, random forest, KNN, and SVM. The resulting RMSE and R-Squared from each machine learning model and imputation method were used to identify the most effective imputation method and model combination for this dataset.
