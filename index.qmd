...
The correlation matrix shows a lot of strong correlation between the predictors in the model. Some of the strongest correlations are as follows (|correlation| >0.5):
